...
<LabNote>
  ...
  <div slot="visual">
    <Handwritten 
      src="/anxiety_porfolio/math-dark.png" 
      invert={false} 
...
After deriving the formula, I realized that <Handwritten src="/anxiety_porfolio/notes.png" inline={true} invert={true} /> was actually zero in this specific configuration. This simplified the Python code significantly.